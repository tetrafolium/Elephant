...
public class MarkdownEditor
  ...
  private Button mItalicBtn, mImageBtn, mLinkBtn, mCiteBtn, mLineBtn,
      mStrongBtn;

  public MarkdownEditor(Context context) { this(context, null); }
  ...
  private void init(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    int layoutId = a.getResourceId(R.styleable.MarkdownEditor_layout,
                                   R.layout.mk_editor_layout);
