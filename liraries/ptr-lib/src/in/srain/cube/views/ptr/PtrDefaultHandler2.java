...
public abstract class PtrDefaultHandler2
    extends PtrDefaultHandler implements PtrHandler2 {
   ...
   * @return
   */
  public static boolean checkContentCanBePulledUp(PtrFrameLayout frame,
