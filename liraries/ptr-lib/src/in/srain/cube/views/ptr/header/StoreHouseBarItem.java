...
public class StoreHouseBarItem extends Animation {
  ...
  public StoreHouseBarItem(int index, PointF start, PointF end, int color,
                           int lineWidth) {
    this.index = index;
  ...
  public void setLineWidth(int width) { mPaint.setStrokeWidth(width); }
  ...
  public void resetPosition(int horizontalRandomness) {
    ...
    int randomNumber =
        -random.nextInt(horizontalRandomness) + horizontalRandomness;
  ...
  public void setAlpha(float alpha) { mPaint.setAlpha((int)(alpha * 255)); }

  public void draw(Canvas canvas) {
    canvas.drawLine(mCStartPoint.x, mCStartPoint.y, mCEndPoint.x, mCEndPoint.y,
                    mPaint);
  }
}