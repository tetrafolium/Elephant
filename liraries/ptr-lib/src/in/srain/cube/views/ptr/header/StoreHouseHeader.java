...
public class StoreHouseHeader extends View implements PtrUIHandler {
  ...
  public ArrayList<StoreHouseBarItem> mItemList =
      new ArrayList<StoreHouseBarItem>();
  ...
  private void setProgress(float progress) { mProgress = progress; }

  public int getLoadingAniDuration() { return mLoadingAniDuration; }
  ...
  public void initWithString(String str) { initWithString(str, 25); }

  public void initWithString(String str, int fontSize) {
    ArrayList<float[]> pointList =
        StoreHousePath.getPath(str, fontSize * 0.01f, 14);
  ...
  public void initWithPointList(ArrayList<float[]> pointList) {
    ...
    for (int i = 0; i < pointList.size(); i++) {
      ...
      StoreHouseBarItem item = new StoreHouseBarItem(i, startPoint, endPoint,
