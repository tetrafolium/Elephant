...
class PtrUIHandlerHolder implements PtrUIHandler {
  ...
  public boolean hasHandler() { return mHandler != null; }

  private PtrUIHandler getHandler() { return mHandler; }
  ...
  public static PtrUIHandlerHolder create() { return new PtrUIHandlerHolder(); }
