...
public class MaterialProgressDrawable extends Drawable implements Animatable {
  ...
  private final int[] COLORS =
      new int[] {0xFFC93437, 0xFF375BF1, 0xFFF7D23E, 0xFF34A350};
  /**
  ...
  public void updateSizes(int size) {
    if (size == LARGE) {
      setSizeParameters(CIRCLE_DIAMETER_LARGE, CIRCLE_DIAMETER_LARGE,
                        CENTER_RADIUS_LARGE, STROKE_WIDTH_LARGE,
   ...
   */
  public void showArrow(boolean show) { mRing.setShowArrow(show); }

  /**
   * @param scale Set the scale of the arrowhead for the spinner.
   */
  public void setArrowScale(float scale) { mRing.setArrowScale(scale); }
  ...
  public int getAlpha() { return mRing.getAlpha(); }
  ...
  private void setupAnimators() {
    ...
    final Animation finishRingAnimation = new Animation() {
      public void applyTransformation(float interpolatedTime,
                                      Transformation t) {
        // shrink back down and complete a full rotation before starting other
        // circles Rotation goes between [0..1].
        float targetRotation =
            (float)(Math.floor(ring.getStartingRotation() / MAX_PROGRESS_ARC) +
                    1f);
  ...
  private static class Ring {
    ...
    private void drawTriangle(Canvas c, float startAngle, float sweepAngle,
      ...
      if (mShowArrow) {
        ...
        float x =
            (float)(mRingCenterRadius * Math.cos(0) + bounds.exactCenterX());
        float y =
            (float)(mRingCenterRadius * Math.sin(0) + bounds.exactCenterY());
     ...
     *
     * @param colors Array of integers describing the colors. Must be
     *     non-<code>null</code>.
     */
     ...
     */
    public void setColorIndex(int index) { mColorIndex = index; }
    ...
    /**
     * @param alpha Set the alpha of the progress spinner and associated
     *     arrowhead.
     */
    ...
    /**
     * @param strokeWidth Set the stroke width of the progress spinner in
     *     pixels.
     */
    ...
    public float getStartingStartTrim() { return mStartingStartTrim; }

    public float getStartingEndTrim() { return mStartingEndTrim; }
    ...
    public double getCenterRadius() { return mRingCenterRadius; }
     ...
     *     [0..1].
     */
    public float getStartingRotation() { return mStartingRotation; }
  ...
  private class OvalShadow extends OvalShape {
    ...
    public OvalShadow(int shadowRadius, int circleDiameter) {
      ...
      mRadialGradient = new RadialGradient(
          mCircleDiameter / 2, mCircleDiameter / 2, mShadowRadius,
          new int[] {FILL_SHADOW_COLOR, Color.TRANSPARENT}, null,
    ...
    public void draw(Canvas canvas, Paint paint) {
      ...
      canvas.drawCircle(viewWidth / 2, viewHeight / 2, (mCircleDiameter / 2),
                        paint);
    }
  }
}