...
public class PermissionsChecker {
  ...
  public static String[] photosPermissions =
  ...
  private PermissionsChecker(Context context) { mContext = (Activity)context; }
  ...
  public static boolean lacksPermissions(Context context,
    ...
    if (closePermissions.size() != 0) {
      openPermission(
          closePermissions.toArray(new String[closePermissions.size()]));
      return false;
    } else {
      return true;
    }
  ...
  private static void openPermission(final String[] permission) {
    if (ActivityCompat.shouldShowRequestPermissionRationale(
                             ...
                             new DialogInterface.OnClickListener() {
                               ...
                               public void onClick(DialogInterface dialog,
                                 ...
                                 ActivityCompat.requestPermissions(
                                     mContext, permission,
                                     REQUEST_STORAGE_PERMISSION); //请求开启权限
                               }
                             })
      ...
      ActivityCompat.requestPermissions(mContext, permission,
