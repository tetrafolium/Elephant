...
public class DrawerMenuAdapter
    extends RecyclerView.Adapter<DrawerMenuAdapter.DrawerHolder> {
  ...
  public DrawerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    return new DrawerHolder(LayoutInflater.from(mContext).inflate(
        R.layout.item_drawer_menu, parent, false));
  }
  ...
  public void onBindViewHolder(final DrawerHolder holder, int position) {
    ...
    if (mSelectPosition == position) {
      holder.itemView.setBackgroundColor(
          ContextCompat.getColor(mContext, R.color.line_space));
    } else {
      holder.itemView.setBackgroundColor(
  ...
  public void
  setOnMenuItemClickListener(OnMenuItemClickListener onMenuItemClickListener) {
