...
public class VoteDialog extends Dialog implements View.OnClickListener {
  ...
  @BindView(R.id.vote_up_tv) TextView mVoteUpTv;
  @BindView(R.id.vote_down_tv) TextView mVoteDownTv;
  ...
  private void initContentView() {
    View view =
        LayoutInflater.from(mContext).inflate(R.layout.dialog_vote, null);
  ...
  public void onClick(View v) {
    ...
    case R.id.vote_up_tv:
      if (mOnVoteDialogClickListener != null)
        mOnVoteDialogClickListener.onVoteUpClick();
      break;
    }
  }
  ...
  public void setOnVoteDialogClickListener(
      OnVoteDialogClickListener onVoteDialogClickListener) {
