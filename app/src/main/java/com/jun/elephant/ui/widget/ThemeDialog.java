...
public class ThemeDialog extends Dialog implements View.OnClickListener {
  ...
  public ThemeDialog(Context context) { this(context, R.style.MyDialog_style); }
  ...
  private void initContentView() {
    View view =
        LayoutInflater.from(mContext).inflate(R.layout.dialog_theme, null);
  ...
  public interface OnThemeChangeListener { void onChangeTheme(View view); }

  public void
  setOnThemeChangeListener(OnThemeChangeListener onThemeChangeListener) {
