...
public class TopicPublishActivity
    extends BaseFrameActivity<TopicPublishPresenter, TopicPublishModel>
    implements Toolbar.OnMenuItemClickListener, TopicPublishContract.View {

  @BindView(R.id.toolBar) Toolbar mToolBar;
  @BindView(R.id.topic_title_edt) EditText mTopicTitleEdt;
  @BindView(R.id.topic_node_tv) TextView mTopicNodeTv;
  @BindView(R.id.topic_content_edt) MarkdownEditText mTopicContentEdt;
  @BindView(R.id.edit_opt_ll) LinearLayout mEditOptLl;
  ...
  @OnClick({R.id.topic_node_tv, R.id.edit_bold_ib, R.id.edit_code_ib,
            R.id.edit_img_ib, R.id.edit_italic_ib, R.id.edit_line_ib,
            R.id.edit_link_ib, R.id.edit_list_ib, R.id.edit_quote_ib,
            R.id.edit_title_ib})
  @Override
  public void
  onClick(View v) {
  ...
  public boolean onMenuItemClick(MenuItem item) {
    ...
    case R.id.action_preview:
      ...
      bundle.putString(Constants.Key.PREVIEW_TOPIC_TITLE,
                       mTopicTitleEdt.getText().toString());
      bundle.putString(
          Constants.Key.PREVIEW_TOPIC_CONTENT,
          mTopicContentEdt.getText().toString().replace("\n-", "\n\n-"));
