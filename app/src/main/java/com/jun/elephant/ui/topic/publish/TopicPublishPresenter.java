...
public class TopicPublishPresenter extends TopicPublishContract.Presenter {
  ...
  private Observer<CategoryEntity> mCategoryObserver =
      new Observer<CategoryEntity>() {
        @Override
  ...
  private Observer<TopicPublishEntity> mTopicDetailObserver =
      new Observer<TopicPublishEntity>() {
        @Override
        public void onCompleted() {
          mView.onRequestEnd();
        }
