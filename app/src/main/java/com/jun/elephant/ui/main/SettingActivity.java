...
public class SettingActivity
    extends BaseActivity implements MaterialDialog.SingleButtonCallback {

  @BindView(R.id.toolBar) Toolbar mToolBar;
  @BindView(R.id.version_tv) TextView mVersionTv;
  @BindView(R.id.cache_size_tv) TextView mCacheSizeTv;
  ...
  public void initView() {
    ...
    mVersionTv.setText(String.valueOf(getString(R.string.app_name) + " " +
                                      SystemUtil.getVersionName(this)));
    mCacheSizeTv.setText(getCacheSize());
  }

  @OnClick({R.id.feedback_tv, R.id.clear_cache_ll, R.id.about_app_tv,
            R.id.get_open_source_tv, R.id.about_phphub_tv, R.id.about_me_tv})
  public void
  onClick(View view) {
    switch (view.getId()) {
  ...
  private String getCacheSize() {
    File dirCacheFile =
        Elephant.getOwnCacheDirectory(this, Elephant.APP_CACHE_PATH);
