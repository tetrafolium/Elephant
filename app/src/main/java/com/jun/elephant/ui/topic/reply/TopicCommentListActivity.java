 ...
 */
public class TopicCommentListActivity
    extends BaseFrameWebViewActivity<TopicReplyPresenter, TopicReplyModel>
    implements TopicReplyContract.View {
  @BindView(R.id.toolBar) Toolbar mToolBar;
  @BindView(R.id.multiStateView) MultiStateView mMultiStateView;
  @BindView(R.id.webView) WebView mWebView;
  @BindView(R.id.bottom_rl) LinearLayout mBottomRl;
  @BindView(R.id.comment_edt) AppCompatEditText mCommentEdt;

  private String mCommentUrl;

  private int mTopicId;

  public static Intent newIntent(Context context, String commentUrl,
                                 int topicId) {
  ...
  public void replySuccess(TopicReplyEntity topicReplyEntity) {
    mCommentEdt.setText("");
    if (topicReplyEntity.getData() != null)
      mWebView.loadUrl(mCommentUrl, getAuth());
  }
