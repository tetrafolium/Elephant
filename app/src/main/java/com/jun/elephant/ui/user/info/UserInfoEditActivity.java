...
public class UserInfoEditActivity
  ...
  @BindView(R.id.name_tv) TextView mUserNameTv;
  @BindView(R.id.signature_tv) TextView mUserSignatureTv;
  @BindView(R.id.user_address_tv) TextView mUserAddressTv;
  @BindView(R.id.user_github_tv) TextView mUserGithubTv;
  @BindView(R.id.user_blog_tv) TextView mUserBlogTv;
  @BindView(R.id.user_twitter_tv) TextView mUserTwitterTv;
  @BindView(R.id.intro_tv) TextView mIntroTv;
  ...
  public void initData() {
    super.initData();
    mUserEntity =
        getIntent().getExtras().getParcelable(Constants.Key.USER_DATA);
  }
  ...
  @OnClick({R.id.user_name_ll, R.id.user_signature_ll, R.id.user_intro_ll,
            R.id.user_address_ll, R.id.user_github_ll, R.id.user_blog_ll,
            R.id.user_twitter_ll})
  public void
  onClick(View view) {
    int id = view.getId();
    switch (id) {
  ...
  MaterialDialog.InputCallback nameCallback =
  ...
  MaterialDialog.InputCallback introCallback =
      new MaterialDialog.InputCallback() {
        @Override
        public void onInput(@NonNull MaterialDialog dialog,
                            CharSequence input) {
  ...
  MaterialDialog.InputCallback signatureCallback =
      new MaterialDialog.InputCallback() {
        @Override
        public void onInput(@NonNull MaterialDialog dialog,
                            CharSequence input) {
  ...
  MaterialDialog.InputCallback addressCallback =
      new MaterialDialog.InputCallback() {
        @Override
        public void onInput(@NonNull MaterialDialog dialog,
                            CharSequence input) {
  ...
  MaterialDialog.InputCallback githubCallback =
      new MaterialDialog.InputCallback() {
        @Override
        public void onInput(@NonNull MaterialDialog dialog,
                            CharSequence input) {
  ...
  MaterialDialog.InputCallback blogCallback =
      new MaterialDialog.InputCallback() {
        @Override
        public void onInput(@NonNull MaterialDialog dialog,
                            CharSequence input) {
  ...
  MaterialDialog.InputCallback twitterCallback =
      new MaterialDialog.InputCallback() {
        @Override
        public void onInput(@NonNull MaterialDialog dialog,
                            CharSequence input) {
