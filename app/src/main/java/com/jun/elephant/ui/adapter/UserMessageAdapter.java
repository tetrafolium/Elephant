...
public class UserMessageAdapter
    extends RecyclerView.Adapter<UserMessageAdapter.MessageViewHolder> {
  ...
  public MessageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    return new MessageViewHolder(LayoutInflater.from(mContext).inflate(
    ...
    holder.itemView.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if (mEntity.getTopic().getData() != null) {
          mContext.startActivity(TopicDetailsActivity.newIntent(
              mContext, mEntity.getTopic().getData().getId()));
        }
      }
    });
    ...
    holder.mAvatarIv.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        mContext.startActivity(
            UserInfoActivity.newIntent(mContext, mUserEntity.getId()));
      }
    });
  }
