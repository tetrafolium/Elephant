...
public class Networks {
  ...
  public static void setToken(String mToken) { Networks.mToken = mToken; }
  ...
  public TopicApi getTopicApi() {
    return mTopicApi == null ? configRetrofit(TopicApi.class, false)
                             : mTopicApi;
  }
  ...
  private OkHttpClient configClient(final boolean isGetToken) {
    ...
    Interceptor headerIntercept = new Interceptor() {
      ...
      public Response intercept(Chain chain) throws IOException {
        ...
        builder.addHeader("X-Client-Build",
