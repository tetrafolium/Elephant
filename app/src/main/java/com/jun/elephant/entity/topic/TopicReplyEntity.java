...
public class TopicReplyEntity {
  ...
  public ReplyEntity getData() { return data; }

  public void setData(ReplyEntity data) { this.data = data; }

  public static class ReplyEntity {
    @SerializedName("topic_id") int topicId;

    String body;

    @SerializedName("user_id") int userId;

    @SerializedName("body_original") String bodyOriginal;
    ...
    public String getBodyOriginal() { return bodyOriginal; }
