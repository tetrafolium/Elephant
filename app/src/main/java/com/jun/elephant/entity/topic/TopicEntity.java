...
public class TopicEntity implements Parcelable {
  ...
  @SerializedName("is_excellent") private boolean isExcellent;
  @SerializedName("reply_count") private int replyCount;
  ...
  @SerializedName("vote_down") private boolean voteDown;

  @SerializedName("vote_up") private boolean voteUp;

  private LinksBean links;

  private UserBean user;

  @SerializedName("last_reply_user") private LastReplyUser lastReplyUser;
  ...
  public LastReplyUser getLastReplyUser() { return lastReplyUser; }
  ...
  public boolean isIsExcellent() { return isExcellent; }
  ...
  public boolean isVoteDown() { return voteDown; }

  public void setVoteDown(boolean voteDown) { this.voteDown = voteDown; }

  public boolean isVoteUp() { return voteUp; }

  public void setVoteUp(boolean voteUp) { this.voteUp = voteUp; }

  public static class LinksBean implements Parcelable {
    @SerializedName("details_web_view") private String detailsWebView;
    @SerializedName("replies_web_view") private String repliesWebView;
    @SerializedName("web_url") private String webUrl;

    public String getDetailsWebView() { return detailsWebView; }

    public void setDetailsWebView(String detailsWebView) {
      this.detailsWebView = detailsWebView;
    }

    public String getRepliesWebView() { return repliesWebView; }
    ...
    public static final Parcelable.Creator<LinksBean> CREATOR =
        new Parcelable.Creator<LinksBean>() {
          @Override
  ...
  public static class UserBean implements Parcelable {
    ...
    public static class DataEntity implements Parcelable {
      ...
      public static final Parcelable.Creator<DataEntity> CREATOR =
          new Parcelable.Creator<DataEntity>() {
            @Override
  ...
  public static class LastReplyUser implements Parcelable {
    ...
    public static final Parcelable.Creator<LastReplyUser> CREATOR =
        new Parcelable.Creator<LastReplyUser>() {
          @Override
  ...
  public static class Category implements Parcelable {
    ...
    public CategoryEntity.Category getData() { return data; }

    public void setData(CategoryEntity.Category data) { this.data = data; }
    ...
    protected Category(Parcel in) {
      this.data =
          in.readParcelable(CategoryEntity.Category.class.getClassLoader());
    }
  ...
  protected TopicEntity(Parcel in) {
    ...
    this.lastReplyUser =
        in.readParcelable(LastReplyUser.class.getClassLoader());
    this.category = in.readParcelable(Category.class.getClassLoader());
  }

  public static final Parcelable.Creator<TopicEntity> CREATOR =
      new Parcelable.Creator<TopicEntity>() {
        @Override
