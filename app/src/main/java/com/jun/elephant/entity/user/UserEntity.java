...
public class UserEntity implements Parcelable {
  ...
  /**
   * replies_web_view :
   * https://staging_api.phphub.org/v1/users/1/replies/web_view
   */
  ...
  public int getTopic_count() { return topic_count; }
  ...
  public boolean isIs_banned() { return is_banned; }
  ...
  public String getGithub_name() { return github_name; }
  ...
  public String getPersonal_website() { return personal_website; }
  ...
  public static class LinksBean implements Parcelable {
    ...
    protected LinksBean(Parcel in) { this.replies_web_view = in.readString(); }
